    ...
    <div className="container">
      <div className="options">
        <div className="option" onClick={() => handleFeatureClick('collage')}>
          <img src={getImageSrc('collage')} alt="Collage" style={{ width: '80px', height: '80px' }}className='feature-icon' />
          <p style={{color: selectedFeature === 'collage' ? 'black' : 'gray'}}>Collage</p>
        {selectedFeature === 'collage' && <p className="typing-effect">Description of Watermark feature...</p>}
        </div>

        <div className="option" onClick={() => handleFeatureClick('watermark')}>
          <img src={getImageSrc('watermark')} alt="Watermark" style={{ width: '80px', height: '80px' }} className='feature-icon'/>
        ...
        <div className="option" onClick={() => handleFeatureClick('size')}>
          <img src={getImageSrc('size')} alt="Sizing" style={{ width: '60px', height: '60px', marginTop: '13px' }} className='feature-icon' />
